...
class _userAuthScreenState extends State<userAuthScreen>
  ...
  Map<String, dynamic> authentication = {"Email": "", "Password": ""};
    ...
    try {
      if (_authMode == AuthMode.SignIn) {
        await Provider.of<Auth>(context, listen: false)
            .signUp(authentication["Email"], authentication["Password"])
            .then((_) {
          setState(() {
            isLoading = false;
          });
        ...
        await Provider.of<Auth>(context, listen: false)
            .logIn(authentication["Email"], authentication["Password"])
            .then((_) {
          setState(() {
            isLoading = false;
          });
                      ...
                      children: [
                        ...
                        TextFormField(
                          decoration: InputDecoration(
                            ...
                            hintText: _authMode == AuthMode.LogIn
                                ? "Enter Email"
                                : "Email",
